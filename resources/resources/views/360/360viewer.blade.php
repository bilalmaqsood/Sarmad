...
<main class="app-main">
    ...
    <div class="hidden" data-image-base="{{ asset('upload/' . $tour->user_id . '/tours/lu11ql/rooms') }}/"></div>

    <div class="images hidden">
        @foreach ($rooms as $room)
            <div class="hidden"
                 data-image
                 data-image-src="{{ asset('upload/' . $tour->user_id . '/tours/lu11ql/rooms/' . $room->name . '.jpg') }}"
            ></div>
        @endforeach
    </div>
