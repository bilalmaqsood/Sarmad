...
$countries = [
	...
	['country_code' => 'AS', 'name' => 'AmericanSamoa', 'dial_code' => '+1 684'],
	['country_code' => 'AD', 'name' => 'Andorra', 'dial_code' => '+376'],
	['country_code' => 'AO', 'name' => 'Angola', 'dial_code' => '+244'],
	['country_code' => 'AI', 'name' => 'Anguilla', 'dial_code' => '+1 264'],
	...
	['country_code' => 'BS', 'name' => 'Bahamas', 'dial_code' => '+1 242'],
	['country_code' => 'BH', 'name' => 'Bahrain', 'dial_code' => '+973'],
	['country_code' => 'BD', 'name' => 'Bangladesh', 'dial_code' => '+880'],
	['country_code' => 'BB', 'name' => 'Barbados', 'dial_code' => '+1 246'],
	...
	['country_code' => 'BM', 'name' => 'Bermuda', 'dial_code' => '+1 441'],
	['country_code' => 'BT', 'name' => 'Bhutan', 'dial_code' => '+975'],
	['country_code' => 'BA', 'name' => 'Bosnia and Herzegovina', 'dial_code' => '+387'],
	['country_code' => 'BW', 'name' => 'Botswana', 'dial_code' => '+267'],
	['country_code' => 'BR', 'name' => 'Brazil', 'dial_code' => '+55'],
	['country_code' => 'IO', 'name' => 'British Indian Ocean Territory', 'dial_code' => '+246'],
	...
	['country_code' => 'CV', 'name' => 'Cape Verde', 'dial_code' => '+238'],
	['country_code' => 'KY', 'name' => 'Cayman Islands', 'dial_code' => '+ 345'],
	['country_code' => 'CF', 'name' => 'Central African Republic', 'dial_code' => '+236'],
	...
	['country_code' => 'CG', 'name' => 'Congo', 'dial_code' => '+242'],
	...
	['country_code' => 'CY', 'name' => 'Cyprus', 'dial_code' => '+537'],
	...
	['country_code' => 'DM', 'name' => 'Dominica', 'dial_code' => '+1 767'],
	['country_code' => 'DO', 'name' => 'Dominican Republic', 'dial_code' => '+1 849'],
	...
	['country_code' => 'GD', 'name' => 'Grenada', 'dial_code' => '+1 473'],
	['country_code' => 'GP', 'name' => 'Guadeloupe', 'dial_code' => '+590'],
	['country_code' => 'GU', 'name' => 'Guam', 'dial_code' => '+1 671'],
	...
	['country_code' => 'GY', 'name' => 'Guyana', 'dial_code' => '+595'],
	...
	['country_code' => 'AN', 'name' => 'Netherlands Antilles', 'dial_code' => '+599'],
	...
	['country_code' => 'MP', 'name' => 'Northern Mariana Islands', 'dial_code' => '+1 670'],
	...
	['country_code' => 'PR', 'name' => 'Puerto Rico', 'dial_code' => '+1 939'],
	...
	['country_code' => 'GS', 'name' => 'South Georgia and the South Sandwich Islands', 'dial_code' => '+500'],
	...
	['country_code' => 'TT', 'name' => 'Trinidad and Tobago', 'dial_code' => '+1 868'],
	...
	['country_code' => 'TC', 'name' => 'Turks and Caicos Islands', 'dial_code' => '+1 649'],
	...
	['country_code' => 'US', 'name' => 'United States', 'dial_code' => '+1'],
	...
	['country_code' => 'ZW', 'name' => 'Zimbabwe', 'dial_code' => '+263'],
	['country_code' => 'AX', 'name' => 'land Islands', 'dial_code' => ''],
	['country_code' => 'AQ', 'name' => 'Antarctica', 'dial_code' => ''],
	['country_code' => 'BO', 'name' => 'Bolivia, Plurinational State of', 'dial_code' => '+591'],
	['country_code' => 'BN', 'name' => 'Brunei Darussalam', 'dial_code' => '+673'],
	['country_code' => 'CC', 'name' => 'Cocos (Keeling) Islands', 'dial_code' => '+61'],
	['country_code' => 'CD', 'name' => 'Congo, The Democratic Republic of the', 'dial_code' => '+243'],
	['country_code' => 'CI', 'name' => 'Cote d\'Ivoire', 'dial_code' => '+225'],
	['country_code' => 'FK', 'name' => 'Falkland Islands (Malvinas)', 'dial_code' => '+500'],
	['country_code' => 'GG', 'name' => 'Guernsey', 'dial_code' => '+44'],
	['country_code' => 'VA', 'name' => 'Holy See (Vatican City State)', 'dial_code' => '+379'],
	['country_code' => 'HK', 'name' => 'Hong Kong', 'dial_code' => '+852'],
	['country_code' => 'IR', 'name' => 'Iran, Islamic Republic of', 'dial_code' => '+98'],
	['country_code' => 'IM', 'name' => 'Isle of Man', 'dial_code' => '+44'],
	['country_code' => 'JE', 'name' => 'Jersey', 'dial_code' => '+44'],
	['country_code' => 'KP', 'name' => 'Korea, Democratic People\'s Republic of', 'dial_code' => '+850'],
	['country_code' => 'KR', 'name' => 'Korea, Republic of', 'dial_code' => '+82'],
	['country_code' => 'LA', 'name' => 'Lao People\'s Democratic Republic', 'dial_code' => '+856'],
	['country_code' => 'LY', 'name' => 'Libyan Arab Jamahiriya', 'dial_code' => '+218'],
	['country_code' => 'MO', 'name' => 'Macao', 'dial_code' => '+853'],
	['country_code' => 'MK', 'name' => 'Macedonia, The Former Yugoslav Republic of', 'dial_code' => '+389'],
	['country_code' => 'FM', 'name' => 'Micronesia, Federated States of', 'dial_code' => '+691'],
	['country_code' => 'MD', 'name' => 'Moldova, Republic of', 'dial_code' => '+373'],
	['country_code' => 'MZ', 'name' => 'Mozambique', 'dial_code' => '+258'],
	['country_code' => 'PS', 'name' => 'Palestinian Territory, Occupied', 'dial_code' => '+970'],
	['country_code' => 'PN', 'name' => 'Pitcairn', 'dial_code' => '+872'],
	['country_code' => 'RE', 'name' => 'Réunion', 'dial_code' => '+262'],
	['country_code' => 'RU', 'name' => 'Russia', 'dial_code' => '+7'],
	['country_code' => 'BL', 'name' => 'Saint Barthélemy', 'dial_code' => '+590'],
	['country_code' => 'SH', 'name' => 'Saint Helena, Ascension and Tristan Da Cunha', 'dial_code' => '+290'],
	['country_code' => 'KN', 'name' => 'Saint Kitts and Nevis', 'dial_code' => '+1 869'],
	['country_code' => 'LC', 'name' => 'Saint Lucia', 'dial_code' => '+1 758'],
	['country_code' => 'MF', 'name' => 'Saint Martin', 'dial_code' => '+590'],
	['country_code' => 'PM', 'name' => 'Saint Pierre and Miquelon', 'dial_code' => '+508'],
	['country_code' => 'VC', 'name' => 'Saint Vincent and the Grenadines', 'dial_code' => '+1 784'],
	['country_code' => 'ST', 'name' => 'Sao Tome and Principe', 'dial_code' => '+239'],
	['country_code' => 'SO', 'name' => 'Somalia', 'dial_code' => '+252'],
	['country_code' => 'SJ', 'name' => 'Svalbard and Jan Mayen', 'dial_code' => '+47'],
	['country_code' => 'SY', 'name' => 'Syrian Arab Republic', 'dial_code' => '+963'],
	['country_code' => 'TW', 'name' => 'Taiwan, Province of China', 'dial_code' => '+886'],
	['country_code' => 'TZ', 'name' => 'Tanzania, United Republic of', 'dial_code' => '+255'],
	['country_code' => 'TL', 'name' => 'Timor-Leste', 'dial_code' => '+670'],
	['country_code' => 'VE', 'name' => 'Venezuela, Bolivarian Republic of', 'dial_code' => '+58'],
	['country_code' => 'VN', 'name' => 'Viet Nam', 'dial_code' => '+84'],
	['country_code' => 'VG', 'name' => 'Virgin Islands, British', 'dial_code' => '+1 284'],
	['country_code' => 'VI', 'name' => 'Virgin Islands, U.S.', 'dial_code' => '+1 340']
];